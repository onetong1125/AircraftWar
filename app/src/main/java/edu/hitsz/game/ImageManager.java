...
public class ImageManager {
    ...
    public static void initImage(Context context){
        ...
        CLASSNAME_IMAGE_MAP.put(Blood.class.getName(), HP_SUPPLY_IMAGE);
        CLASSNAME_IMAGE_MAP.put(Bomb.class.getName(), BOMB_SUPPLY_IMAGE);
        CLASSNAME_IMAGE_MAP.put(Bullet.class.getName(), FIRE_SUPPLY_IMAGE);
    }
